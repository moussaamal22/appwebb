...
export default function SignUp({ navigation }) {
  ...
  const signUpUser = async () => {
    ...
    try {
      const response = await axios.post('https://bb8d-196-179-92-208.ngrok-free.app/project/user/create', user, {
        headers: {
          'Content-Type': 'application/json',
        },
      });
      const response2= await axios.get(`https://bb8d-196-179-92-208.ngrok-free.app/project/user/'${email}'`, {
        headers: {
          'Content-Type': 'application/json',
        },
      });
      ...
      const response3 = await axios.post('https://bb8d-196-179-92-208.ngrok-free.app/project/admin/create', admin, {
        headers: {
          'Content-Type': 'application/json',
        },
      });
