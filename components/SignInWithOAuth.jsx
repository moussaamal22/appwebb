...
export default function SignInWithOAuth({ navigation }) {
  ...
  const onPress = async () => {
    try {
      ...
      const response = await axios.post("https://bb8d-196-179-92-208.ngrok-free.app/project/user/create", { email: userEmail });
  ...
  const onPress2 = async () => {
    try {
      const response= await axios.get(`https://bb8d-196-179-92-208.ngrok-free.app/project/user/'${email}'`, {
        headers: {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <TouchableOpacity style={styles.btnSignUp} onPress={onPress}>
          ...
          <ImageBackground source = {require('./../assets/images/gg.png')} style = {styles.googleLogo}>
          </ImageBackground>
        </TouchableOpacity>
