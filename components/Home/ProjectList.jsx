...
const ProjectList = ({ navigation }) => {
    ...
    const fetchProjects = async () => {
      try {
        ...
        const response = await axios.get(
          `https://bb8d-196-179-92-208.ngrok-free.app/project/project/${utilisateur}`,
          {
            headers: {
  ...
  const addProject = async () => {
    ...
    try {
      const response = await axios.post('https://bb8d-196-179-92-208.ngrok-free.app/project/project/create', projectData, {
        headers: {
          'Content-Type': 'application/json',
        },
      });
  ...
  const updateProject = async () => {
    try {
      const response = await axios.put(
        `https://bb8d-196-179-92-208.ngrok-free.app/project/project/update`,
        null,
        {
          params: {
  ...
  const fetchProjects = async () => {
    try {
      setProjects([]); // Réinitialise les projets dans l'état avant de les mettre à jour
  ...
  const deleteProject = (id) => {
    axios.delete(`https://bb8d-196-179-92-208.ngrok-free.app/project/project/delete?id=${id}`)
      .then(() => {
